...
void main() {
  ...
  test('Shoulb throw unexpectedError if HttpClient return 404', () async {
    when(httpClient.request(
            url: anyNamed('url'),
            method: anyNamed('method'),
            body: anyNamed('body')))
  ...
  test('Shoulb throw unexpectedError if HttpClient return 500', () async {
    when(httpClient.request(
            url: anyNamed('url'),
            method: anyNamed('method'),
            body: anyNamed('body')))
  ...
  test(
      'Shoulb throw unexpectedError id HttpClient returns 200 with invalidCredentials',
      () async {
    when(httpClient.request(
            url: anyNamed('url'),
            method: anyNamed('method'),
